...
<div id="left_col">
 ...
 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <ul class="post_info">
   ...
   <?php if ($options['show_comment']): ?><li class="write_comment"><a href="<?php the_permalink() ?>#comments"><?php _e('Write comment','black-piano'); ?></a></li><?php endif; ?>
 ...
 <?php if ($options['show_next_post']) : ?> <div id="prev_next_post" class="cf">
