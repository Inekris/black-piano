 ...
 <fieldset class="comment_form_wrapper" id="respond">
  ...
  <form action="<?php echo esc_url(site_url('/')); ?>wp-comments-post.php" method="post" id="commentform">
   ...
   <div id="submit_comment_wrapper">
    ...
    <input name="submit" type="submit" id="submit_comment" tabindex="5" value="<?php _e('Submit Comment', 'black-piano'); ?>" title="<?php _e('Submit Comment', 'black-piano'); ?>" alt="<?php _e('Submit Comment', 'black-piano'); ?>" />
   </div>
